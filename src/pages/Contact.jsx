  ...
  return (
    <div className="flex flex-col items-center  tracking-wider">
      <div className="flex flex-wrap justify-center items-center gap-[30px]">
        <div className="flex flex-col items-start  text-left gap-[24px] py-[40px] ">
      ...
      <div className="flex flex-col items-center gap-[80px] py-[112px]">
        ...
        <div className="flex flex-wrap justify-center items-center ">
          <div className="flex flex-col items-center gap-[15px]  px-[40px] py-[50px] ">
          ...
          <div className="flex flex-col items-center gap-[15px]  px-[40px] py-[80px] bg-[#252B42] text-white">
            <Icon
